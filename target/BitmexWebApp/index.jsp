...
<form name="botDataForm" action="javascript:void(null);">
    ...
    <input type="text" id="akey" name="akey" value="qSMU1A_dtkZPaHpJk1GM7ulA"><br>
    <label for="asecret">API Secret:</label><br>
    <input type="text" id="asecret" name="asecret" value="gydFxkSa6-vYL-TnhELzul8AhtrXA3CFmyJHPcNPXFfG3KQ5"><br>
    <label for="stp">Step:</label><br>
    <input type="text" id="stp" name="stp" value="200"><br>
    <label for="lvl">Level:</label><br>
    <input type="text" id="lvl" name="lvl" value="2"><br>
    <label for="coef">Coefficient:</label><br>
    <input type="text" id="coef" name="coef" value="100"><br>
...
<script>
    ...
    $(document).ready(function () {
        ...
        var validData = false;
        $("#submit").click(function sendF(event) {
            var formData = {
                akey: $("#akey").val(),
                asecret: $("#asecret").val(),
                stp: $("#stp").val(),
